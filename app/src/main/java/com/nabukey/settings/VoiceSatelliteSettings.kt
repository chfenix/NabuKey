package com.nabukey.settings

import android.content.Context
import com.nabukey.utils.getRandomMacAddressString
import dagger.Binds
...
class VoiceSatelliteSettingsStoreImpl @Inject constructor(@ApplicationContext context: Context) :
    ...
    override suspend fun ensureMacAddressIsSet() {
        update {
            // For development convenience, use a fixed MAC address to avoid creating new HA integrations on reinstall
